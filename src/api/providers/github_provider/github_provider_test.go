...
func TestCreateRepoNoError(t *testing.T) {
	...
	restclient.AddMockup(restclient.Mock{
		...
		Response: &http.Response{
			StatusCode: http.StatusCreated,
			Body:       io.NopCloser(strings.NewReader(`{"id": 123, "name": "golang-tutorial", "full_name": "aemloviji/golang-guide-microservices"}`)),
		},
	})
	...
	assert.EqualValues(t, "aemloviji/golang-guide-microservices", response.FullName)
}
